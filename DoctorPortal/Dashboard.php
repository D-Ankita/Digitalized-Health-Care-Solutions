...
<body>
	...
	<div class="navbar">
		<ul>
			<li><a href="#" id="nav1"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
			<li><a href="#" id="nav2">About us</a></li>
			<li><a href="#" id="nav3">Contact us</a></li>
		</ul>
	</div>

	<div class="sidebar">
		<ul>
			<li class="active"><a class="active" href="#"><svg class=
...
Calendar</a></li>
	...
	<div class="backdrop">
		...
		<div class="notification1">
			<img src="patient.jpg">
			<p>Patient Monica will be connected with you in 5 minutes</p>
		</div>
		<div class="notification2">
			<img src="patient.jpg">
			<p>Miss. Phoebe Hannigan wants to take an appoinment for her migrane checkup</p>
		</div>
		<i class="fa newnot fa-caret-down" aria-hidden="true"></i>

		<h6 id="newapp">New Appointments</h6>
		<div class="appoinment">
			<div class="appoinment1">
				<img src="patient.jpg">
				<p id="app1_name">Miss.Buffay</p>
				<p id="app1_reason">Migrane</p>
				<a href="#" id="accept1">Accept</a>
				<a href="#" id="wait1">Wait</a>
			</div>
			<div class="appoinment2">
				<img src="patient.jpg">
				<p id="app2_name">Miss.Geller</p>
				<p id="app2_reason">Diabetes</p>
				<a href="#" id="accept2">Accept</a>
				<a href="#" id="wait2">Wait</a>
			</div>
			<div class="appoinment3">
				<img src="patient.jpg">
				<p id="app3_name">Miss.Green</p>
				<p id="app3_reason">ulcer</p>
				<a href="#" id="accept3">Accept</a>
				<a href="#" id="wait3">Wait</a> 
			</div>
		</div>
		<i class="fa newappoint fa-caret-down" aria-hidden="true"></i>
		...
		<div class="schedule-box">
			<h6>Schedule</h6>
			<a href="#">Today<i class="fa fa-angle-down" aria-hidden="true"></i></a>
		</div>
		<img src="patient.jpg" class="profile-pic">
		<div class="profile-pic-box">
			<p id="docname">Ms. Rachel Green</p>
			<p id="qualification">MDBS M.D (Medical)</p>
			<hr>
			<p id="mile1">200 new patients</p>
			<p id="mile2">300 Patients permonth</p>
			<p id="mile3">165 satisfied patients</p>
		
		</div>
		<div class="description-box">
			<div class="content">
			<p class="heading"><i class="fa fa-user-md" aria-hidden="true"></i>About me</p>
			<p>Responsible physician with 9 years of experience
             maximizing patient wellness and facility profitability. Seeking to 
             deliver healthcare excellence at Mercy Hospital. 
             At Phoenix,maintained 5-star healthgrades score for 112 reviews
             and 85% patient success. <br>Speciality:   OPHTHALMOLOGY, PAEDIATRIC SMALL STEPS<br>
             Consultant Type: Honorary Consultant</p>
			<p class="heading"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Education</p>
			<p>Doctor of Medicine<br>
			Loma Linda University, CA<br>
			2011–2015<br>
			Internal Medicine Residency, San Jose Hospital<br>
			Vice President, Student National Medical <br>
			Association chapter	</p>
			<p class="heading"><i class="fa fa-suitcase" aria-hidden="true"></i>Experience</p>
			<p>24 Years of experience</p>
			<p class="heading">
			<i class="fa fa-bookmark" aria-hidden="true"></i>License</p>
			<p>2019 — Board certified,<br> Medical Board of California</p>
			<p class="heading"><i class="fa fa-video-camera" aria-hidden="true"></i>Google meet link</p>
			<p class="heading">Goal</p>
			<p>To relief the pain and suffering, promote health and the prevention of disease,forestalling of death and the cure of disease when possible and the care of those who can not be cured,to prevent abuse and to enhance the quality of care.</p>
		</div>
		</div>
