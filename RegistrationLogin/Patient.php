...
<body>
  ...
  <div class="loginbox">
       ...
       <h3> Register yourself as a Patient</h3>  
...
<form method="POST" onsubmit="return validation()" >
        ...
        <div class="bottom">
          ...
          <div class="pass" style="padding-bottom: 10px;"><a href="Patientlogin.php">Already have an Account?</a>
          </div>
...
<?php  
  ...
  if (isset($_POST['submit'])) 
  {
    ...
    $confpassword = $_POST['confpassword'];
     ...
     $check = "SELECT * FROM patientsignin WHERE email = '$email' && mobile = '$mobile' ";
...
<?php
      ...
      {                                   
          $insertquery = "INSERT INTO `patientsignin`( `firstname`, `lastname`, `dob`, `email`, `mobile`, `address`, `gender`, `password`, `confpassword`) VALUES ('$firstname','$lastname','$dob','$email','$mobile','$address','$gender','$password','$confpassword')";
      ...
      ?>
                  <script>  
                    ...
                    location.href = 'Patientlogin.php';
                  </script>
                  <?php
          }
          else{
